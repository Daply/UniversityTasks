...
public class AreaControllingFirstRobot extends FirstRobot {
	...
	protected AreaControllingFirstRobot(ControllArea area, AbstractRobot robot, int place1, int place2) {
	...
	public boolean executeCommand(int command) {
		...
		switch (command) {
			case 1:
				area.lookRight(place1, place2, 1);
				break;
			case 2:
				area.lookLeft(place1, place2, 1);
				break;
			case 3:
				area.lookFront(place1, place2, 1);
				break;
			case 4:
