...
/**
 * Created by Daria on 16.10.2014.
 */
...
class Program {
	...
	public static void main(String[] args) {
		Computer[] a = new Computer[6];
		a[0] = new Computer("Samsung", Processor.QUAD_CORE, 128, 2014, 9);
		a[1] = new Computer("Lenovo", Processor.DUAL_CORE, 240, 2014, 8);
		a[2] = new Laptop("Asus", Processor.QUAD_CORE, 64, 2014, 8, "bat2", 28, 14, 1.5);
		a[3] = new Computer("Lenovo", Processor.QUAD_CORE, 1024, 2014, 8);
		a[4] = new Computer("Samsung", Processor.THREE_CORE, 500, 2012, 8);
		a[5] = new Laptop("Siemens", Processor.SINGLE_CORE, 512, 2013, 9, "bat1", 34, 23, 3);
